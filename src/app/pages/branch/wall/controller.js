...
class BranchWallController extends Injectable {
  constructor(...injections) {
    ...
    listeners.push($rs.$watch(() => ctrls.postType.selectedIndex, this.callbackDropdown));
    listeners.push($rs.$watch(() => ctrls.sortBy.selectedIndex, this.callbackDropdown));
    listeners.push($rs.$watch(() => ctrls.statType.selectedIndex, this.callbackDropdown));
    listeners.push($rs.$watch(() => ctrls.timeRange.selectedIndex, this.callbackDropdown));
